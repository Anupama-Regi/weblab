...
$sql="insert into exercise11 values('$n1','$gender','$pwd','$e','$ph')";
if(mysqli_query($conn,$sql))
	{
  	echo '<script>alert("Registration Successful...");</script>';
    		header("refresh:3;url=Exercise--11.php");
   	}
	else
	{
		echo '<script>alert("Registration Unsuccessful...");</script>';
 		echo"Registration Unsuccessful:<hr>".mysqli_error($conn);
 		header("refresh:5;url=Exercise--11.php");
	}
mysqli_close($conn);}
}
...
<body align=center>
<marquee onmouseover=this.stop() onmouseout=this.start()><h1>Form Validation</h1></marquee> 
<form method="post" action="Exercise--11.php" name="form1" onsubmit="return registration()">
<table align="center" border="1">
<tr><td colspan="2" style="vertical-align:top;text-align:center;font-weight:bold;font-style:normal;text-decoration:underline;">REGISTRATION FORM</td></tr>
